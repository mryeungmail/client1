...
public class signUp_activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		radio.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				if(radio.getCheckedRadioButtonId() == R.id.cb_signup_man)
					mySex ="M";
				if(radio.getCheckedRadioButtonId() == R.id.cb_signup_woman)
					mySex ="F";
			}
		});
		
		//cb_man = (RadioButton) findViewById(R.id.cb_signup_man);
		//cb_woman = (RadioButton) findViewById(R.id.cb_signup_woman);
						...
						handle.post(new Runnable() { // main Thread���� ����
							...
							public void run() {
								...
								*/
								...
								Toast.makeText(signUp_activity.this,	"" + myName + "님 회원가입 되었습니다",Toast.LENGTH_SHORT).show();
	...
	public void Signup_Submit() {
		try {
			...
			URL url = new URL("http://johnnase.cafe24.com/client1_moon/sign_up.php"); // URL
	...
	public void Id_check_HTTPPOST() {
		try {
			...
			// URL �����ϰ� �����ϱ�
			// --------------------------
			URL url = new URL("http://johnnase.cafe24.com/client1_moon/id_check.php"); 
			HttpURLConnection http = (HttpURLConnection) url.openConnection(); // ����
			...
			http.setRequestProperty("content-type",	"application/x-www-form-urlencoded");
			StringBuffer buffer = new StringBuffer();
			buffer.append("mb_id").append("=").append(myId).append("&");
			//buffer.append(myId);
